...
from beet.rpc.full_node_rpc_client import FullNodeRpcClient
...
from beet.util.bech32m import decode_puzzle_hash
from beet.util.condition_tools import parse_sexp_to_conditions
from beet.util.config import load_config
from beet.util.default_root import DEFAULT_ROOT_PATH
from beet.util.ints import uint32, uint16
...
async def main() -> None:
    ...
    try:
        ...
        address1 = "xbt1rdatypul5c642jkeh4yp933zu3hw8vv8tfup8ta6zfampnyhjnusxdgns6"  # Key 1
        address2 = "xbt1duvy5ur5eyj7lp5geetfg84cj2d7xgpxt7pya3lr2y6ke3696w9qvda66e"  # Key 2
