...
from beet.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "51010"
            testnet_introducer = "beta1_introducer.beetnetwork.org"
            testnet = "testnet7"
            ...
            mainnet_port = "1010"
            mainnet_introducer = "introducer.beetnetwork.org"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running beet services for changes to take effect")
